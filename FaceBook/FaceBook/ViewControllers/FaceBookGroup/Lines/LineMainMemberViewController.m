//
//  LineMainMemberViewController.m
//  FaceBook
//
...
@interface LineMainMemberViewController ()

@end

@implementation LineMainMemberViewController
...
- (PSCollectionViewCell *)collectionView:(PSCollectionView *)collectionView viewAtIndex:(NSInteger)index {
    ...
    NSDictionary *item = [linesArray objectAtIndex:index];
...
- (void)collectionView:(PSCollectionView *)collectionView didSelectView:(PSCollectionViewCell *)view atIndex:(NSInteger)index {
    ...
    if ([globalVariable.lineis_memberString integerValue]==0) {
        ///进入加站内联系人页面
